---
name: ticket-triage (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (customer-support/skills/ticket-triage). Apache-2.0, Copyright Anthropic PBC.
source: https://github.com/anthropics/knowledge-work-plugins/tree/main/customer-support/skills/ticket-triage
license: Apache-2.0
---
