---
name: reconciliation (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (finance/skills/reconciliation). Apache-2.0, Copyright Anthropic PBC.
