---
name: kb-article (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (customer-support/skills/kb-article). Apache-2.0, Copyright Anthropic PBC.
source: https://github.com/anthropics/knowledge-work-plugins/tree/main/customer-support/skills/kb-article
license: Apache-2.0
---
