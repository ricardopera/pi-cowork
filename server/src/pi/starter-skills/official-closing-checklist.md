---
name: closing-checklist (Anthropic legal)
description: Adapted from Anthropic's claude-for-legal (corporate-legal/skills/closing-checklist). Apache-2.0, Copyright Anthropic PBC.
source: https://github.com/anthropics/claude-for-legal/tree/main/corporate-legal/skills/closing-checklist
license: Apache-2.0
---
