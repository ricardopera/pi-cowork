---
name: stakeholder-update (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (product-management/skills/stakeholder-update). Apache-2.0, Copyright Anthropic PBC.
