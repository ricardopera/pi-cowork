---
name: audit-support (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (finance/skills/audit-support). Apache-2.0, Copyright Anthropic PBC.
