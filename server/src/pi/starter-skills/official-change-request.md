---
name: change-request (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (operations/skills/change-request). Apache-2.0, Copyright Anthropic PBC.
