---
name: content-creation (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (marketing/skills/content-creation). Apache-2.0, Copyright Anthropic PBC.
source: https://github.com/anthropics/knowledge-work-plugins/tree/main/marketing/skills/content-creation
license: Apache-2.0
---
