---
name: business-pulse (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (small-business/skills/business-pulse). Apache-2.0, Copyright Anthropic PBC.
