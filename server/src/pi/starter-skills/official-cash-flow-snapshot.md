---
name: cash-flow-snapshot (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (small-business/skills/cash-flow-snapshot). Apache-2.0, Copyright Anthropic PBC.
