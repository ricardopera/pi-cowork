---
name: process-doc (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (operations/skills/process-doc). Apache-2.0, Copyright Anthropic PBC.
