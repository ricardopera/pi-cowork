---
name: capacity-plan (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (operations/skills/capacity-plan). Apache-2.0, Copyright Anthropic PBC.
