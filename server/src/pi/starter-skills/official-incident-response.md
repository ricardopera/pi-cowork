---
name: incident-response (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (engineering/skills/incident-response). Apache-2.0, Copyright Anthropic PBC.
source: https://github.com/anthropics/knowledge-work-plugins/tree/main/engineering/skills/incident-response
license: Apache-2.0
---
