---
name: deploy-checklist (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (engineering/skills/deploy-checklist). Apache-2.0, Copyright Anthropic PBC.
