---
name: build-dashboard (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (data/skills/build-dashboard). Apache-2.0, Copyright Anthropic PBC.
