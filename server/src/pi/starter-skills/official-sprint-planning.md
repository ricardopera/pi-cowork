---
name: sprint-planning (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (product-management/skills/sprint-planning). Apache-2.0, Copyright Anthropic PBC.
