---
name: risk-assessment (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (operations/skills/risk-assessment). Apache-2.0, Copyright Anthropic PBC.
