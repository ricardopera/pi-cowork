---
name: roadmap-update (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (product-management/skills/roadmap-update). Apache-2.0, Copyright Anthropic PBC.
