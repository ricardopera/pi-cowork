---
name: metrics-review (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (product-management/skills/metrics-review). Apache-2.0, Copyright Anthropic PBC.
