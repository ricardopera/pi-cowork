---
name: board-minutes (Anthropic legal)
description: Adapted from Anthropic's claude-for-legal (corporate-legal/skills/board-minutes). Apache-2.0, Copyright Anthropic PBC.
source: https://github.com/anthropics/claude-for-legal/tree/main/corporate-legal/skills/board-minutes
license: Apache-2.0
---
