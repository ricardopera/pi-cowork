---
name: campaign-plan (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (marketing/skills/campaign-plan). Apache-2.0, Copyright Anthropic PBC.
source: https://github.com/anthropics/knowledge-work-plugins/tree/main/marketing/skills/campaign-plan
license: Apache-2.0
---
