---
name: email-sequence (Anthropic)
description: Adapted from Anthropic's knowledge-work-plugins (marketing/skills/email-sequence). Apache-2.0, Copyright Anthropic PBC.
source: https://github.com/anthropics/knowledge-work-plugins/tree/main/marketing/skills/email-sequence
license: Apache-2.0
---
