...
- *Browser control (15):* navigate, click, type, scrape, screenshot, close, tab list/new/switch/close, JS execution, form-fill, wait-for-selector, network-request inspection, console-message capture (Playwright)
- *Computer-use (14):* screenshot, mouse move/click/drag, scroll + scroll-direction, type, key + key-combo chords, modifier+click, clipboard read/write, wait, multi-region capture (native automation via nut-js)
